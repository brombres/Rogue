...
syn keyword bardLoop         while endWhile forEach endForEach 
...
syn keyword bardStorageClass native requisite abstract final propagated functional dynamicAccess
