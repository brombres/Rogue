#ifndef BARDXC_DEFINES_H
#define BARDXC_DEFINES_H
...
#ifndef BARD_XC_BYTES_BEFORE_AUTO_GC
#  define BARD_XC_BYTES_BEFORE_AUTO_GC (512*1024)
#endif
...
#define BARD_XC_allocate(type)             ((type*)Bard_allocate_bytes_and_clear(sizeof(type)))
...
#define BardVM_pop_character( vm )  ((BardXCCharacter)((vm->sp++)->integer))
#define BardVM_pop_logical( vm )    ((BardXCInteger)((vm->sp++)->integer))
#define BardVM_pop_byte( vm )       ((BardXCByte)((vm->sp++)->integer))
...
#define BardVM_peek_byte( vm )     ((BardXCByte)(vm->sp->integer))

#define BardList_data(list)  (*((BardArray**)(((char*)list) + list->type->vm->BardList_data_offset)))
#define BardList_count(list) (*((BardXCInteger*)(((char*)list) + list->type->vm->BardList_count_offset)))
