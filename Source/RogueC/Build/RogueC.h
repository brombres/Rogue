...
RogueClassTokenType* RogueTokenType__init__String( RogueClassTokenType* THIS, RogueString* _auto_98_0 );
...
RogueClassCmdLabel* RogueCmdLabel__init__Token_String_CmdStatementList( RogueClassCmdLabel* THIS, RogueClassToken* _auto_99_0, RogueString* _auto_100_1, RogueClassCmdStatementList* _auto_101_2 );
...
RogueClassRogueError* RogueRogueError__init__String_String_Integer_Integer( RogueClassRogueError* THIS, RogueString* _auto_111_0, RogueString* _auto_112_1, RogueInteger _auto_113_2, RogueInteger _auto_114_3 );
RogueString* RogueTemplateArray__type_name( RogueArray* THIS );
RogueString* RogueCPPWriter__type_name( RogueClassCPPWriter* THIS );
RogueClassCPPWriter* RogueCPPWriter__init__String( RogueClassCPPWriter* THIS, RogueString* _auto_151_0 );
...
RogueClassLocal* RogueLocal__init__Token_String( RogueClassLocal* THIS, RogueClassToken* _auto_178_0, RogueString* _auto_179_1 );
...
RogueClassFile* RogueFile__init__String( RogueClassFile* THIS, RogueString* _auto_247_0 );
...
void RogueParser__parse_type_def__Type( RogueClassParser* THIS, RogueClassType* _auto_257_0 );
...
RogueClassLineReader* RogueLineReader__init__CharacterReader( RogueClassLineReader* THIS, RogueClassCharacterReader* _auto_262_0 );
...
RogueClassTypeParameter* RogueTypeParameter__init__Token_String( RogueClassTypeParameter* THIS, RogueClassToken* _auto_277_0, RogueString* _auto_278_1 );
...
RogueClassAugment* RogueAugment__init__Token_String( RogueClassAugment* THIS, RogueClassToken* _auto_280_0, RogueString* _auto_281_1 );
...
RogueClassLiteralCharacterToken* RogueLiteralCharacterToken__init__TokenType_Character( RogueClassLiteralCharacterToken* THIS, RogueClassTokenType* _auto_285_0, RogueCharacter _auto_286_1 );
...
RogueClassLiteralLongToken* RogueLiteralLongToken__init__TokenType_Long( RogueClassLiteralLongToken* THIS, RogueClassTokenType* _auto_287_0, RogueLong _auto_288_1 );
...
RogueClassLiteralIntegerToken* RogueLiteralIntegerToken__init__TokenType_Integer( RogueClassLiteralIntegerToken* THIS, RogueClassTokenType* _auto_289_0, RogueInteger _auto_290_1 );
...
RogueClassLiteralRealToken* RogueLiteralRealToken__init__TokenType_Real( RogueClassLiteralRealToken* THIS, RogueClassTokenType* _auto_291_0, RogueReal _auto_292_1 );
...
RogueClassLiteralStringToken* RogueLiteralStringToken__init__TokenType_String( RogueClassLiteralStringToken* THIS, RogueClassTokenType* _auto_293_0, RogueString* _auto_294_1 );
...
RogueClassTypeSpecializer* RogueTypeSpecializer__init__String_Integer( RogueClassTypeSpecializer* THIS, RogueString* _auto_306_0, RogueInteger _auto_307_1 );
...
RogueClassCloneMethodArgs* RogueCloneMethodArgs__init__Method( RogueClassCloneMethodArgs* THIS, RogueClassMethod* _auto_334_0 );
...
RogueClassCmdAccess* RogueCmdAccess__init__Token_String( RogueClassCmdAccess* THIS, RogueClassToken* _auto_339_0, RogueString* _auto_340_1 );
RogueClassCmdAccess* RogueCmdAccess__init__Token_String_CmdArgs( RogueClassCmdAccess* THIS, RogueClassToken* _auto_341_0, RogueString* _auto_342_1, RogueClassCmdArgs* _auto_343_2 );
RogueClassCmdAccess* RogueCmdAccess__init__Token_Cmd_String( RogueClassCmdAccess* THIS, RogueClassToken* _auto_344_0, RogueClassCmd* _auto_345_1, RogueString* _auto_346_2 );
RogueClassCmdAccess* RogueCmdAccess__init__Token_Cmd_String_CmdArgs( RogueClassCmdAccess* THIS, RogueClassToken* _auto_347_0, RogueClassCmd* _auto_348_1, RogueString* _auto_349_2, RogueClassCmdArgs* _auto_350_3 );
RogueClassCmdAccess* RogueCmdAccess__init__Token_Cmd_String_Cmd( RogueClassCmdAccess* THIS, RogueClassToken* _auto_351_0, RogueClassCmd* _auto_352_1, RogueString* _auto_353_2, RogueClassCmd* arg_3 );
...
RogueClassCmdAssign* RogueCmdAssign__init__Token_Cmd_Cmd( RogueClassCmdAssign* THIS, RogueClassToken* _auto_354_0, RogueClassCmd* _auto_355_1, RogueClassCmd* _auto_356_2 );
RogueString* RogueScope__type_name( RogueClassScope* THIS );
RogueClassScope* RogueScope__init__Type_Method( RogueClassScope* THIS, RogueClassType* _auto_359_0, RogueClassMethod* _auto_360_1 );
...
RogueClassCmdThisContext* RogueCmdThisContext__init__Token_Type( RogueClassCmdThisContext* THIS, RogueClassToken* _auto_365_0, RogueClassType* _auto_366_1 );
...
RogueClassCmdGenericLoop* RogueCmdGenericLoop__init__Token_Integer_Cmd_CmdStatementList_CmdStatementList_CmdStatementList( RogueClassCmdGenericLoop* THIS, RogueClassToken* _auto_369_0, RogueInteger _auto_370_1, RogueClassCmd* _auto_371_2, RogueClassCmdStatementList* _auto_372_3, RogueClassCmdStatementList* _auto_373_4, RogueClassCmdStatementList* _auto_374_5 );
...
RogueClassCmdLiteralInteger* RogueCmdLiteralInteger__init__Token_Integer( RogueClassCmdLiteralInteger* THIS, RogueClassToken* _auto_380_0, RogueInteger _auto_381_1 );
...
RogueClassCmdBinary* RogueCmdBinary__init__Token_Cmd_Cmd( RogueClassCmdBinary* THIS, RogueClassToken* _auto_382_0, RogueClassCmd* _auto_383_1, RogueClassCmd* _auto_384_2 );
...
RogueClassTaskArgs* RogueTaskArgs__init__Type_Method_Type_Method( RogueClassTaskArgs* THIS, RogueClassType* _auto_391_0, RogueClassMethod* _auto_392_1, RogueClassType* _auto_393_2, RogueClassMethod* _auto_394_3 );
...
RogueClassCmdTaskControl* RogueCmdTaskControl__init__Token( RogueClassCmdTaskControl* THIS, RogueClassToken* _auto_397_0 );
...
RogueClassCmdTaskControlSection* RogueCmdTaskControlSection__init__Integer( RogueClassCmdTaskControlSection* THIS, RogueInteger _auto_398_0 );
...
RogueClassCmdLiteralNull* RogueCmdLiteralNull__init__Token( RogueClassCmdLiteralNull* THIS, RogueClassToken* _auto_435_0 );
...
RogueClassCmdCreateCompound* RogueCmdCreateCompound__init__Token_Type_CmdArgs( RogueClassCmdCreateCompound* THIS, RogueClassToken* _auto_436_0, RogueClassType* _auto_437_1, RogueClassCmdArgs* _auto_438_2 );
...
RogueClassCmdLiteralLogical* RogueCmdLiteralLogical__init__Token_Logical( RogueClassCmdLiteralLogical* THIS, RogueClassToken* _auto_439_0, RogueLogical _auto_440_1 );
...
RogueClassCmdLiteralString* RogueCmdLiteralString__init__Token_String_Integer( RogueClassCmdLiteralString* THIS, RogueClassToken* _auto_451_0, RogueString* _auto_452_1, RogueInteger _auto_453_2 );
...
RogueClassCmdWriteGlobal* RogueCmdWriteGlobal__init__Token_Property_Cmd( RogueClassCmdWriteGlobal* THIS, RogueClassToken* _auto_462_0, RogueClassProperty* _auto_463_1, RogueClassCmd* _auto_464_2 );
...
RogueClassCmdWriteProperty* RogueCmdWriteProperty__init__Token_Cmd_Property_Cmd( RogueClassCmdWriteProperty* THIS, RogueClassToken* _auto_465_0, RogueClassCmd* _auto_466_1, RogueClassProperty* _auto_467_2, RogueClassCmd* _auto_468_3 );
...
RogueClassCmdTypeOperator* RogueCmdTypeOperator__init__Token_Cmd_Type( RogueClassCmdTypeOperator* THIS, RogueClassToken* _auto_567_0, RogueClassCmd* _auto_568_1, RogueClassType* _auto_569_2 );
...
RogueClassCmdUnary* RogueCmdUnary__init__Token_Cmd( RogueClassCmdUnary* THIS, RogueClassToken* _auto_570_0, RogueClassCmd* _auto_571_1 );
...
RogueClassCmdCreateOptionalValue* RogueCmdCreateOptionalValue__init__Token_Type_Cmd( RogueClassCmdCreateOptionalValue* THIS, RogueClassToken* _auto_572_0, RogueClassType* _auto_573_1, RogueClassCmd* _auto_574_2 );
...
RogueClassMacroArgs* RogueMacroArgs__init__Cmd_Method_CmdArgs( RogueClassMacroArgs* THIS, RogueClassCmd* _auto_870_0, RogueClassMethod* _auto_871_1, RogueClassCmdArgs* args_2 );
...
RogueClassCmdReadSingleton* RogueCmdReadSingleton__init__Token_Type( RogueClassCmdReadSingleton* THIS, RogueClassToken* _auto_872_0, RogueClassType* _auto_873_1 );
...
RogueClassCmdCreateArray* RogueCmdCreateArray__init__Token_Type_CmdArgs( RogueClassCmdCreateArray* THIS, RogueClassToken* _auto_874_0, RogueClassType* _auto_875_1, RogueClassCmdArgs* args_2 );
RogueClassCmdCreateArray* RogueCmdCreateArray__init__Token_Type_Cmd( RogueClassCmdCreateArray* THIS, RogueClassToken* _auto_876_0, RogueClassType* _auto_877_1, RogueClassCmd* _auto_878_2 );
...
RogueClassCmdCall* RogueCmdCall__init__Token_Cmd_Method_CmdArgs( RogueClassCmdCall* THIS, RogueClassToken* _auto_879_0, RogueClassCmd* _auto_880_1, RogueClassMethod* _auto_881_2, RogueClassCmdArgs* _auto_882_3 );
...
RogueClassCmdCreateObject* RogueCmdCreateObject__init__Token_Type( RogueClassCmdCreateObject* THIS, RogueClassToken* _auto_886_0, RogueClassType* _auto_887_1 );
...
RogueClassCmdReadGlobal* RogueCmdReadGlobal__init__Token_Property( RogueClassCmdReadGlobal* THIS, RogueClassToken* _auto_888_0, RogueClassProperty* _auto_889_1 );
...
RogueClassCmdReadProperty* RogueCmdReadProperty__init__Token_Cmd_Property( RogueClassCmdReadProperty* THIS, RogueClassToken* _auto_890_0, RogueClassCmd* _auto_891_1, RogueClassProperty* _auto_892_2 );
...
RogueClassCmdLogicalizeOptionalValue* RogueCmdLogicalizeOptionalValue__init__Token_Cmd_Logical( RogueClassCmdLogicalizeOptionalValue* THIS, RogueClassToken* _auto_893_0, RogueClassCmd* _auto_894_1, RogueLogical _auto_895_2 );
...
RogueClassCmdWriteLocal* RogueCmdWriteLocal__init__Token_Local_Cmd( RogueClassCmdWriteLocal* THIS, RogueClassToken* _auto_897_0, RogueClassLocal* _auto_898_1, RogueClassCmd* _auto_899_2 );
...
RogueClassCmdOpAssignGlobal* RogueCmdOpAssignGlobal__init__Token_Property_TokenType_Cmd( RogueClassCmdOpAssignGlobal* THIS, RogueClassToken* _auto_900_0, RogueClassProperty* _auto_901_1, RogueClassTokenType* _auto_902_2, RogueClassCmd* _auto_903_3 );
...
RogueClassCmdOpAssignProperty* RogueCmdOpAssignProperty__init__Token_Cmd_Property_TokenType_Cmd( RogueClassCmdOpAssignProperty* THIS, RogueClassToken* _auto_904_0, RogueClassCmd* _auto_905_1, RogueClassProperty* _auto_906_2, RogueClassTokenType* _auto_907_3, RogueClassCmd* _auto_908_4 );
...
RogueClassCmdCallInlineNativeRoutine* RogueCmdCallInlineNativeRoutine__init__Token_Method_CmdArgs( RogueClassCmdCallInlineNativeRoutine* THIS, RogueClassToken* _auto_917_0, RogueClassMethod* _auto_918_1, RogueClassCmdArgs* _auto_919_2 );
...
RogueClassCmdCallNativeRoutine* RogueCmdCallNativeRoutine__init__Token_Method_CmdArgs( RogueClassCmdCallNativeRoutine* THIS, RogueClassToken* _auto_920_0, RogueClassMethod* _auto_921_1, RogueClassCmdArgs* _auto_922_2 );
...
RogueClassCmdReadArrayCount* RogueCmdReadArrayCount__init__Token_Cmd( RogueClassCmdReadArrayCount* THIS, RogueClassToken* _auto_925_0, RogueClassCmd* _auto_926_1 );
...
RogueClassCandidateMethods* RogueCandidateMethods__init__Type_CmdAccess_Logical( RogueClassCandidateMethods* THIS, RogueClassType* _auto_930_0, RogueClassCmdAccess* _auto_931_1, RogueLogical _auto_932_2 );
...
RogueClassCmdBlock* RogueCmdBlock__init__Token_Integer( RogueClassCmdBlock* THIS, RogueClassToken* _auto_991_0, RogueInteger _auto_992_1 );
RogueClassCmdBlock* RogueCmdBlock__init__Token_CmdStatementList_Integer( RogueClassCmdBlock* THIS, RogueClassToken* _auto_993_0, RogueClassCmdStatementList* _auto_994_1, RogueInteger _auto_995_2 );
...
RogueClassEOLToken* RogueEOLToken__init__TokenType_String( RogueClassEOLToken* THIS, RogueClassTokenType* _auto_1067_0, RogueString* _auto_1068_1 );
...
RogueClassPreprocessorTokenReader* RoguePreprocessorTokenReader__init__TokenList( RogueClassPreprocessorTokenReader* THIS, RogueTokenList* _auto_1083_0 );
...
RogueClassCmdSwitch* RogueCmdSwitch__init__Token_Cmd_CmdWhichCaseList_CmdWhichCase_Integer( RogueClassCmdSwitch* THIS, RogueClassToken* _auto_1097_0, RogueClassCmd* _auto_1098_1, RogueCmdWhichCaseList* _auto_1099_2, RogueClassCmdWhichCase* _auto_1100_3, RogueInteger _auto_1101_4 );
...
RogueClassCmdReadArrayElement* RogueCmdReadArrayElement__init__Token_Cmd_Cmd( RogueClassCmdReadArrayElement* THIS, RogueClassToken* _auto_1146_0, RogueClassCmd* _auto_1147_1, RogueClassCmd* _auto_1148_2 );
...
RogueClassCmdWriteArrayElement* RogueCmdWriteArrayElement__init__Token_Cmd_Cmd_Cmd( RogueClassCmdWriteArrayElement* THIS, RogueClassToken* _auto_1149_0, RogueClassCmd* _auto_1150_1, RogueClassCmd* _auto_1151_2, RogueClassCmd* _auto_1152_3 );
...
RogueClassCmdAdjustGlobal* RogueCmdAdjustGlobal__init__Token_Property_Integer( RogueClassCmdAdjustGlobal* THIS, RogueClassToken* _auto_1230_0, RogueClassProperty* _auto_1231_1, RogueInteger _auto_1232_2 );
...
RogueClassCmdAdjustProperty* RogueCmdAdjustProperty__init__Token_Cmd_Property_Integer( RogueClassCmdAdjustProperty* THIS, RogueClassToken* _auto_1233_0, RogueClassCmd* _auto_1234_1, RogueClassProperty* _auto_1235_2, RogueInteger _auto_1236_3 );
