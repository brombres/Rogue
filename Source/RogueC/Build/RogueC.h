...
struct RogueClassMethod : RogueObject
{
  ...
  RogueString* java_name;
  RogueString* java_typedef;
...
struct RogueClassType : RogueObject
{
  ...
  RogueString* java_name;
  RogueString* java_class_name;
  RogueString* java_type_name;
...
struct RogueClassJavaWriter : RogueObject
{
  // PROPERTIES
  RogueString* filepath;
  RogueStringBuilder* buffer;
...
extern RogueType* RogueTypeReal;
extern RogueType* RogueTypeLong;
...
extern RogueType* RogueTypeString_IntegerTable;
...
extern RogueType* RogueTypeJavaWriter;
...
extern RogueType* RogueTypeIntegerList;
...
extern RogueType* RogueTypeLiteralLongToken;
extern RogueType* RogueTypeLiteralIntegerToken;
extern RogueType* RogueTypeLiteralRealToken;
...
extern RogueType* RogueTypeCmdLiteralInteger;
...
extern RogueType* RogueTypeTableEntry_of_String_IntegerList;
extern RogueType* RogueTypeString_IntegerTableEntry;
...
extern RogueType* RogueTypeCmdLiteralReal;
extern RogueType* RogueTypeCmdLiteralLong;
...
void RogueRogueC__write_java( RogueClassRogueC* THIS );
...
RogueString* RogueProgram__validate_java_name__String( RogueClassProgram* THIS, RogueString* name_0 );
void RogueProgram__write_java__String( RogueClassProgram* THIS, RogueString* filepath_0 );
void RogueProgram__print_property_trace_code__Type_JavaWriter( RogueClassProgram* THIS, RogueClassType* type_0, RogueClassJavaWriter* writer_1 );
...
RogueClassTemplate* RogueTemplate__init__Token_String_Integer( RogueClassTemplate* THIS, RogueClassToken* _auto_61_0, RogueString* _auto_62_1, RogueInteger attribute_flags_2 );
...
RogueClassRequisiteItem* RogueRequisiteItem__init__Token_Type_String( RogueClassRequisiteItem* THIS, RogueClassToken* _auto_64_0, RogueClassType* _auto_65_1, RogueString* _auto_66_2 );
...
void RogueMethod__assign_java_name( RogueClassMethod* THIS );
void RogueMethod__print_prototype__JavaWriter( RogueClassMethod* THIS, RogueClassJavaWriter* writer_0 );
void RogueMethod__print_signature__JavaWriter( RogueClassMethod* THIS, RogueClassJavaWriter* writer_0 );
void RogueMethod__print_definition__JavaWriter( RogueClassMethod* THIS, RogueClassJavaWriter* writer_0 );
...
RogueClassType* RogueType__init__Token_String( RogueClassType* THIS, RogueClassToken* _auto_74_0, RogueString* _auto_75_1 );
...
void RogueType__assign_java_name( RogueClassType* THIS );
void RogueType__print_data_definition__JavaWriter( RogueClassType* THIS, RogueClassJavaWriter* writer_0 );
void RogueType__print_routine_prototypes__JavaWriter( RogueClassType* THIS, RogueClassJavaWriter* writer_0 );
void RogueType__print_routine_definitions__JavaWriter( RogueClassType* THIS, RogueClassJavaWriter* writer_0 );
void RogueType__print_method_prototypes__JavaWriter( RogueClassType* THIS, RogueClassJavaWriter* writer_0 );
void RogueType__determine_java_method_typedefs__StringList_String_MethodTable( RogueClassType* THIS, RogueStringList* list_0, RogueClassString_MethodTable* lookup_1 );
RogueInteger RogueType__print_dynamic_method_table_entries__Integer_JavaWriter( RogueClassType* THIS, RogueInteger at_index_0, RogueClassJavaWriter* writer_1 );
void RogueType__print_method_definitions__JavaWriter( RogueClassType* THIS, RogueClassJavaWriter* writer_0 );
...
RogueClassToken* RogueToken__init__TokenType( RogueClassToken* THIS, RogueClassTokenType* _auto_77_0 );
...
RogueClassToken* RogueToken__set_location__String_Integer_Integer( RogueClassToken* THIS, RogueString* _auto_78_0, RogueInteger _auto_79_1, RogueInteger _auto_80_2 );
...
RogueClassAttributes* RogueAttributes__init__Integer( RogueClassAttributes* THIS, RogueInteger _auto_83_0 );
...
void RogueCmd__write_java__JavaWriter_Logical( RogueClassCmd* THIS, RogueClassJavaWriter* writer_0, RogueLogical is_statement_1 );
...
void RogueCmdReturn__write_java__JavaWriter_Logical( RogueClassCmdReturn* THIS, RogueClassJavaWriter* writer_0, RogueLogical is_statement_1 );
RogueClassCmdReturn* RogueCmdReturn__init_object( RogueClassCmdReturn* THIS );
RogueClassCmdReturn* RogueCmdReturn__init__Token_Cmd( RogueClassCmdReturn* THIS, RogueClassToken* _auto_85_0, RogueClassCmd* _auto_86_1 );
...
void RogueCmdStatementList__write_java__JavaWriter_Logical( RogueClassCmdStatementList* THIS, RogueClassJavaWriter* writer_0, RogueLogical is_statement_1 );
...
RogueClassTokenType* RogueTokenType__init__String( RogueClassTokenType* THIS, RogueString* _auto_88_0 );
...
void RogueCmdLabel__write_java__JavaWriter_Logical( RogueClassCmdLabel* THIS, RogueClassJavaWriter* writer_0, RogueLogical is_statement_1 );
RogueClassCmdLabel* RogueCmdLabel__init_object( RogueClassCmdLabel* THIS );
RogueClassCmdLabel* RogueCmdLabel__init__Token_String_CmdStatementList( RogueClassCmdLabel* THIS, RogueClassToken* _auto_89_0, RogueString* _auto_90_1, RogueClassCmdStatementList* _auto_91_2 );
...
RogueClassRogueError* RogueRogueError__init__String_String_Integer_Integer( RogueClassRogueError* THIS, RogueString* _auto_94_0, RogueString* _auto_95_1, RogueInteger _auto_96_2, RogueInteger _auto_97_3 );
...
RogueClassCPPWriter* RogueCPPWriter__init__String( RogueClassCPPWriter* THIS, RogueString* _auto_129_0 );
...
RogueClassJavaWriter* RogueJavaWriter__init__String( RogueClassJavaWriter* THIS, RogueString* _auto_138_0 );
void RogueJavaWriter__close( RogueClassJavaWriter* THIS );
void RogueJavaWriter__print_indent( RogueClassJavaWriter* THIS );
RogueClassJavaWriter* RogueJavaWriter__print__Long( RogueClassJavaWriter* THIS, RogueLong value_0 );
RogueClassJavaWriter* RogueJavaWriter__print__Integer( RogueClassJavaWriter* THIS, RogueInteger value_0 );
RogueClassJavaWriter* RogueJavaWriter__print__Real( RogueClassJavaWriter* THIS, RogueReal value_0 );
RogueClassJavaWriter* RogueJavaWriter__print__String( RogueClassJavaWriter* THIS, RogueString* value_0 );
RogueClassJavaWriter* RogueJavaWriter__print_code__String( RogueClassJavaWriter* THIS, RogueString* code_0 );
RogueClassJavaWriter* RogueJavaWriter__println( RogueClassJavaWriter* THIS );
RogueClassJavaWriter* RogueJavaWriter__println__String( RogueClassJavaWriter* THIS, RogueString* value_0 );
RogueClassJavaWriter* RogueJavaWriter__print__Type( RogueClassJavaWriter* THIS, RogueClassType* type_0 );
RogueClassJavaWriter* RogueJavaWriter__print_cast__Type_Type( RogueClassJavaWriter* THIS, RogueClassType* from_type_0, RogueClassType* to_type_1 );
RogueClassJavaWriter* RogueJavaWriter__print_open_cast__Type_Type( RogueClassJavaWriter* THIS, RogueClassType* from_type_0, RogueClassType* to_type_1 );
RogueClassJavaWriter* RogueJavaWriter__print_close_cast__Type_Type( RogueClassJavaWriter* THIS, RogueClassType* from_type_0, RogueClassType* to_type_1 );
RogueClassJavaWriter* RogueJavaWriter__print_cast__Type_Type_Cmd( RogueClassJavaWriter* THIS, RogueClassType* from_type_0, RogueClassType* to_type_1, RogueClassCmd* cmd_2 );
RogueClassJavaWriter* RogueJavaWriter__print_access_operator__Type( RogueClassJavaWriter* THIS, RogueClassType* type_0 );
RogueClassJavaWriter* RogueJavaWriter__print_type_name__Type( RogueClassJavaWriter* THIS, RogueClassType* type_0 );
RogueClassJavaWriter* RogueJavaWriter__print_type_info__Type( RogueClassJavaWriter* THIS, RogueClassType* type_0 );
RogueClassJavaWriter* RogueJavaWriter__print_default_value__Type( RogueClassJavaWriter* THIS, RogueClassType* type_0 );
RogueClassJavaWriter* RogueJavaWriter__print__Character_Logical( RogueClassJavaWriter* THIS, RogueCharacter ch_0, RogueLogical in_string_1 );
RogueClassJavaWriter* RogueJavaWriter__print_string_utf8__String( RogueClassJavaWriter* THIS, RogueString* st_0 );
RogueClassJavaWriter* RogueJavaWriter__init_object( RogueClassJavaWriter* THIS );
...
RogueClassProperty* RogueProperty__init__Token_Type_String_Type_Cmd( RogueClassProperty* THIS, RogueClassToken* _auto_141_0, RogueClassType* _auto_142_1, RogueString* _auto_143_2, RogueClassType* _auto_144_3, RogueClassCmd* _auto_145_4 );
RogueClassProperty* RogueProperty__clone( RogueClassProperty* THIS );
RogueClassProperty* RogueProperty__set_type_context__Type( RogueClassProperty* THIS, RogueClassType* _auto_146_0 );
...
RogueClassLocal* RogueLocal__init__Token_String( RogueClassLocal* THIS, RogueClassToken* _auto_166_0, RogueString* _auto_167_1 );
...
RogueString* RogueLocal__java_name( RogueClassLocal* THIS );
...
RogueClassFile* RogueFile__init__String( RogueClassFile* THIS, RogueString* _auto_314_0 );
...
void RogueParser__parse_type_def__Type( RogueClassParser* THIS, RogueClassType* _auto_322_0 );
...
RogueClassLineReader* RogueLineReader__init__CharacterReader( RogueClassLineReader* THIS, RogueClassCharacterReader* _auto_327_0 );
...
RogueClassTypeParameter* RogueTypeParameter__init__Token_String( RogueClassTypeParameter* THIS, RogueClassToken* _auto_342_0, RogueString* _auto_343_1 );
...
RogueClassAugment* RogueAugment__init__Token_String( RogueClassAugment* THIS, RogueClassToken* _auto_345_0, RogueString* _auto_346_1 );
...
RogueClassLiteralCharacterToken* RogueLiteralCharacterToken__init__TokenType_Character( RogueClassLiteralCharacterToken* THIS, RogueClassTokenType* _auto_350_0, RogueCharacter _auto_351_1 );
...
RogueClassLiteralLongToken* RogueLiteralLongToken__init__TokenType_Long( RogueClassLiteralLongToken* THIS, RogueClassTokenType* _auto_352_0, RogueLong _auto_353_1 );
...
RogueClassLiteralIntegerToken* RogueLiteralIntegerToken__init__TokenType_Integer( RogueClassLiteralIntegerToken* THIS, RogueClassTokenType* _auto_354_0, RogueInteger _auto_355_1 );
...
RogueClassLiteralRealToken* RogueLiteralRealToken__init__TokenType_Real( RogueClassLiteralRealToken* THIS, RogueClassTokenType* _auto_356_0, RogueReal _auto_357_1 );
...
RogueClassLiteralStringToken* RogueLiteralStringToken__init__TokenType_String( RogueClassLiteralStringToken* THIS, RogueClassTokenType* _auto_358_0, RogueString* _auto_359_1 );
...
RogueClassTypeSpecializer* RogueTypeSpecializer__init__String_Integer( RogueClassTypeSpecializer* THIS, RogueString* _auto_371_0, RogueInteger _auto_372_1 );
...
RogueClassCloneMethodArgs* RogueCloneMethodArgs__init__Method( RogueClassCloneMethodArgs* THIS, RogueClassMethod* _auto_399_0 );
...
void RogueCmdAccess__write_java__JavaWriter_Logical( RogueClassCmdAccess* THIS, RogueClassJavaWriter* writer_0, RogueLogical is_statement_1 );
RogueClassCmdAccess* RogueCmdAccess__init_object( RogueClassCmdAccess* THIS );
RogueClassCmdAccess* RogueCmdAccess__init__Token_String( RogueClassCmdAccess* THIS, RogueClassToken* _auto_404_0, RogueString* _auto_405_1 );
RogueClassCmdAccess* RogueCmdAccess__init__Token_String_CmdArgs( RogueClassCmdAccess* THIS, RogueClassToken* _auto_406_0, RogueString* _auto_407_1, RogueClassCmdArgs* _auto_408_2 );
RogueClassCmdAccess* RogueCmdAccess__init__Token_Cmd_String( RogueClassCmdAccess* THIS, RogueClassToken* _auto_409_0, RogueClassCmd* _auto_410_1, RogueString* _auto_411_2 );
RogueClassCmdAccess* RogueCmdAccess__init__Token_Cmd_String_CmdArgs( RogueClassCmdAccess* THIS, RogueClassToken* _auto_412_0, RogueClassCmd* _auto_413_1, RogueString* _auto_414_2, RogueClassCmdArgs* _auto_415_3 );
RogueClassCmdAccess* RogueCmdAccess__init__Token_Cmd_String_Cmd( RogueClassCmdAccess* THIS, RogueClassToken* _auto_416_0, RogueClassCmd* _auto_417_1, RogueString* _auto_418_2, RogueClassCmd* arg_3 );
...
RogueClassCmdAssign* RogueCmdAssign__init__Token_Cmd_Cmd( RogueClassCmdAssign* THIS, RogueClassToken* _auto_419_0, RogueClassCmd* _auto_420_1, RogueClassCmd* _auto_421_2 );
RogueString* RogueScope__type_name( RogueClassScope* THIS );
RogueClassScope* RogueScope__init__Type_Method( RogueClassScope* THIS, RogueClassType* _auto_424_0, RogueClassMethod* _auto_425_1 );
...
void RogueCmdThisContext__write_java__JavaWriter_Logical( RogueClassCmdThisContext* THIS, RogueClassJavaWriter* writer_0, RogueLogical is_statement_1 );
RogueClassCmdThisContext* RogueCmdThisContext__init_object( RogueClassCmdThisContext* THIS );
RogueClassCmdThisContext* RogueCmdThisContext__init__Token_Type( RogueClassCmdThisContext* THIS, RogueClassToken* _auto_430_0, RogueClassType* _auto_431_1 );
...
void RogueCmdGenericLoop__write_java__JavaWriter_Logical( RogueClassCmdGenericLoop* THIS, RogueClassJavaWriter* writer_0, RogueLogical is_statement_1 );
RogueClassCmdGenericLoop* RogueCmdGenericLoop__init_object( RogueClassCmdGenericLoop* THIS );
RogueClassCmdGenericLoop* RogueCmdGenericLoop__init__Token_Integer_Cmd_CmdStatementList_CmdStatementList_CmdStatementList( RogueClassCmdGenericLoop* THIS, RogueClassToken* _auto_434_0, RogueInteger _auto_435_1, RogueClassCmd* _auto_436_2, RogueClassCmdStatementList* _auto_437_3, RogueClassCmdStatementList* _auto_438_4, RogueClassCmdStatementList* _auto_439_5 );
...
void RogueCmdLiteralInteger__write_java__JavaWriter_Logical( RogueClassCmdLiteralInteger* THIS, RogueClassJavaWriter* writer_0, RogueLogical is_statement_1 );
RogueClassCmdLiteralInteger* RogueCmdLiteralInteger__init_object( RogueClassCmdLiteralInteger* THIS );
RogueClassCmdLiteralInteger* RogueCmdLiteralInteger__init__Token_Integer( RogueClassCmdLiteralInteger* THIS, RogueClassToken* _auto_445_0, RogueInteger _auto_446_1 );
...
void RogueCmdBinary__write_java__JavaWriter_Logical( RogueClassCmdBinary* THIS, RogueClassJavaWriter* writer_0, RogueLogical is_statement_1 );
RogueClassCmdBinary* RogueCmdBinary__init_object( RogueClassCmdBinary* THIS );
RogueClassCmdBinary* RogueCmdBinary__init__Token_Cmd_Cmd( RogueClassCmdBinary* THIS, RogueClassToken* _auto_447_0, RogueClassCmd* _auto_448_1, RogueClassCmd* _auto_449_2 );
...
RogueString* RogueCmdBinary__java_symbol( RogueClassCmdBinary* THIS );
...
RogueClassTaskArgs* RogueTaskArgs__init__Type_Method_Type_Method( RogueClassTaskArgs* THIS, RogueClassType* _auto_456_0, RogueClassMethod* _auto_457_1, RogueClassType* _auto_458_2, RogueClassMethod* _auto_459_3 );
...
void RogueCmdTaskControl__write_java__JavaWriter_Logical( RogueClassCmdTaskControl* THIS, RogueClassJavaWriter* writer_0, RogueLogical is_statement_1 );
RogueClassCmdTaskControl* RogueCmdTaskControl__init_object( RogueClassCmdTaskControl* THIS );
RogueClassCmdTaskControl* RogueCmdTaskControl__init__Token( RogueClassCmdTaskControl* THIS, RogueClassToken* _auto_462_0 );
...
RogueClassCmdTaskControlSection* RogueCmdTaskControlSection__init__Integer( RogueClassCmdTaskControlSection* THIS, RogueInteger _auto_463_0 );
...
void RogueCmdLiteralNull__write_java__JavaWriter_Logical( RogueClassCmdLiteralNull* THIS, RogueClassJavaWriter* writer_0, RogueLogical is_statement_1 );
RogueClassCmdLiteralNull* RogueCmdLiteralNull__init_object( RogueClassCmdLiteralNull* THIS );
RogueClassCmdLiteralNull* RogueCmdLiteralNull__init__Token( RogueClassCmdLiteralNull* THIS, RogueClassToken* _auto_498_0 );
...
void RogueCmdCreateCompound__write_java__JavaWriter_Logical( RogueClassCmdCreateCompound* THIS, RogueClassJavaWriter* writer_0, RogueLogical is_statement_1 );
RogueClassCmdCreateCompound* RogueCmdCreateCompound__init_object( RogueClassCmdCreateCompound* THIS );
RogueClassCmdCreateCompound* RogueCmdCreateCompound__init__Token_Type_CmdArgs( RogueClassCmdCreateCompound* THIS, RogueClassToken* _auto_499_0, RogueClassType* _auto_500_1, RogueClassCmdArgs* _auto_501_2 );
...
void RogueCmdLiteralLogical__write_java__JavaWriter_Logical( RogueClassCmdLiteralLogical* THIS, RogueClassJavaWriter* writer_0, RogueLogical is_statement_1 );
RogueClassCmdLiteralLogical* RogueCmdLiteralLogical__init_object( RogueClassCmdLiteralLogical* THIS );
RogueClassCmdLiteralLogical* RogueCmdLiteralLogical__init__Token_Logical( RogueClassCmdLiteralLogical* THIS, RogueClassToken* _auto_502_0, RogueLogical _auto_503_1 );
...
void RogueCmdLiteralString__write_java__JavaWriter_Logical( RogueClassCmdLiteralString* THIS, RogueClassJavaWriter* writer_0, RogueLogical is_statement_1 );
RogueClassCmdLiteralString* RogueCmdLiteralString__init_object( RogueClassCmdLiteralString* THIS );
RogueClassCmdLiteralString* RogueCmdLiteralString__init__Token_String_Integer( RogueClassCmdLiteralString* THIS, RogueClassToken* _auto_514_0, RogueString* _auto_515_1, RogueInteger _auto_516_2 );
...
void RogueCmdWriteGlobal__write_java__JavaWriter_Logical( RogueClassCmdWriteGlobal* THIS, RogueClassJavaWriter* writer_0, RogueLogical is_statement_1 );
RogueClassCmdWriteGlobal* RogueCmdWriteGlobal__init_object( RogueClassCmdWriteGlobal* THIS );
RogueClassCmdWriteGlobal* RogueCmdWriteGlobal__init__Token_Property_Cmd( RogueClassCmdWriteGlobal* THIS, RogueClassToken* _auto_525_0, RogueClassProperty* _auto_526_1, RogueClassCmd* _auto_527_2 );
...
void RogueCmdWriteProperty__write_java__JavaWriter_Logical( RogueClassCmdWriteProperty* THIS, RogueClassJavaWriter* writer_0, RogueLogical is_statement_1 );
RogueClassCmdWriteProperty* RogueCmdWriteProperty__init_object( RogueClassCmdWriteProperty* THIS );
RogueClassCmdWriteProperty* RogueCmdWriteProperty__init__Token_Cmd_Property_Cmd( RogueClassCmdWriteProperty* THIS, RogueClassToken* _auto_528_0, RogueClassCmd* _auto_529_1, RogueClassProperty* _auto_530_2, RogueClassCmd* _auto_531_3 );
...
void RogueCmdCastToType__write_java__JavaWriter_Logical( RogueClassCmdCastToType* THIS, RogueClassJavaWriter* writer_0, RogueLogical is_statement_1 );
...
RogueClassCmdTypeOperator* RogueCmdTypeOperator__init__Token_Cmd_Type( RogueClassCmdTypeOperator* THIS, RogueClassToken* _auto_660_0, RogueClassCmd* _auto_661_1, RogueClassType* _auto_662_2 );
...
RogueString* RogueCmdLogicalize__java_prefix_symbol( RogueClassCmdLogicalize* THIS );
RogueString* RogueCmdLogicalize__java_suffix_symbol( RogueClassCmdLogicalize* THIS );
...
void RogueCmdUnary__write_java__JavaWriter_Logical( RogueClassCmdUnary* THIS, RogueClassJavaWriter* writer_0, RogueLogical is_statement_1 );
RogueClassCmdUnary* RogueCmdUnary__init_object( RogueClassCmdUnary* THIS );
RogueClassCmdUnary* RogueCmdUnary__init__Token_Cmd( RogueClassCmdUnary* THIS, RogueClassToken* _auto_663_0, RogueClassCmd* _auto_664_1 );
...
RogueString* RogueCmdUnary__java_prefix_symbol( RogueClassCmdUnary* THIS );
RogueString* RogueCmdUnary__java_suffix_symbol( RogueClassCmdUnary* THIS );
...
void RogueCmdCreateOptionalValue__write_java__JavaWriter_Logical( RogueClassCmdCreateOptionalValue* THIS, RogueClassJavaWriter* writer_0, RogueLogical is_statement_1 );
RogueClassCmdCreateOptionalValue* RogueCmdCreateOptionalValue__init_object( RogueClassCmdCreateOptionalValue* THIS );
RogueClassCmdCreateOptionalValue* RogueCmdCreateOptionalValue__init__Token_Type_Cmd( RogueClassCmdCreateOptionalValue* THIS, RogueClassToken* _auto_665_0, RogueClassType* _auto_666_1, RogueClassCmd* _auto_667_2 );
...
RogueLogical RogueFileReader__open__String( RogueClassFileReader* THIS, RogueString* _auto_755_0 );
RogueClassFileReader* RogueFileReader__set_position__Integer( RogueClassFileReader* THIS, RogueInteger _auto_756_0 );
...
RogueLogical RogueFileWriter__open__String( RogueClassFileWriter* THIS, RogueString* _auto_757_0 );
...
RogueClassTokenReader* RogueTokenReader__init__TokenList( RogueClassTokenReader* THIS, RogueTokenList* _auto_760_0 );
...
RogueTokenList* RogueTokenizer__tokenize__String( RogueClassTokenizer* THIS, RogueString* _auto_761_0 );
RogueTokenList* RogueTokenizer__tokenize__Token_String_String( RogueClassTokenizer* THIS, RogueClassToken* reference_t_0, RogueString* _auto_762_1, RogueString* data_2 );
RogueTokenList* RogueTokenizer__tokenize__ParseReader( RogueClassTokenizer* THIS, RogueClassParseReader* _auto_763_0 );
...
RogueClassParseReader* RogueParseReader__set_position__Integer_Integer( RogueClassParseReader* THIS, RogueInteger _auto_764_0, RogueInteger _auto_765_1 );
...
RogueTokenList* RoguePreprocessor__process__TokenList( RogueClassPreprocessor* THIS, RogueTokenList* _auto_766_0 );
...
void RogueCmdIf__write_java__JavaWriter_Logical( RogueClassCmdIf* THIS, RogueClassJavaWriter* writer_0, RogueLogical is_statement_1 );
RogueClassCmdIf* RogueCmdIf__init_object( RogueClassCmdIf* THIS );
RogueClassCmdIf* RogueCmdIf__init__Token_Cmd_Integer( RogueClassCmdIf* THIS, RogueClassToken* _auto_773_0, RogueClassCmd* _auto_774_1, RogueInteger _auto_775_2 );
RogueClassCmdIf* RogueCmdIf__init__Token_Cmd_CmdStatementList_Integer( RogueClassCmdIf* THIS, RogueClassToken* _auto_776_0, RogueClassCmd* _auto_777_1, RogueClassCmdStatementList* _auto_778_2, RogueInteger _auto_779_3 );
...
RogueClassCmdWhich* RogueCmdWhich__init__Token_Cmd_CmdWhichCaseList_CmdWhichCase_Integer( RogueClassCmdWhich* THIS, RogueClassToken* _auto_780_0, RogueClassCmd* _auto_781_1, RogueCmdWhichCaseList* _auto_782_2, RogueClassCmdWhichCase* _auto_783_3, RogueInteger _auto_784_4 );
...
void RogueCmdContingent__write_java__JavaWriter_Logical( RogueClassCmdContingent* THIS, RogueClassJavaWriter* writer_0, RogueLogical is_statement_1 );
...
RogueClassCmdContingent* RogueCmdContingent__init__Token_CmdStatementList( RogueClassCmdContingent* THIS, RogueClassToken* _auto_785_0, RogueClassCmdStatementList* _auto_786_1 );
...
void RogueCmdTry__write_java__JavaWriter_Logical( RogueClassCmdTry* THIS, RogueClassJavaWriter* writer_0, RogueLogical is_statement_1 );
RogueClassCmdTry* RogueCmdTry__init_object( RogueClassCmdTry* THIS );
RogueClassCmdTry* RogueCmdTry__init__Token_CmdStatementList_CmdCatchList( RogueClassCmdTry* THIS, RogueClassToken* _auto_787_0, RogueClassCmdStatementList* _auto_788_1, RogueCmdCatchList* _auto_789_2 );
...
RogueClassCmdAwait* RogueCmdAwait__init__Token_Cmd_CmdStatementList_Local( RogueClassCmdAwait* THIS, RogueClassToken* _auto_790_0, RogueClassCmd* _auto_791_1, RogueClassCmdStatementList* _auto_792_2, RogueClassLocal* _auto_793_3 );
...
RogueClassCmdYield* RogueCmdYield__init__Token( RogueClassCmdYield* THIS, RogueClassToken* _auto_794_0 );
...
void RogueCmdThrow__write_java__JavaWriter_Logical( RogueClassCmdThrow* THIS, RogueClassJavaWriter* writer_0, RogueLogical is_statement_1 );
RogueClassCmdThrow* RogueCmdThrow__init_object( RogueClassCmdThrow* THIS );
RogueClassCmdThrow* RogueCmdThrow__init__Token_Cmd( RogueClassCmdThrow* THIS, RogueClassToken* _auto_795_0, RogueClassCmd* _auto_796_1 );
...
RogueClassCmdTrace* RogueCmdTrace__init__Token_String( RogueClassCmdTrace* THIS, RogueClassToken* _auto_797_0, RogueString* _auto_798_1 );
...
void RogueCmdEscape__write_java__JavaWriter_Logical( RogueClassCmdEscape* THIS, RogueClassJavaWriter* writer_0, RogueLogical is_statement_1 );
RogueClassCmdEscape* RogueCmdEscape__init_object( RogueClassCmdEscape* THIS );
RogueClassCmdEscape* RogueCmdEscape__init__Token_Integer_CmdControlStructure( RogueClassCmdEscape* THIS, RogueClassToken* _auto_799_0, RogueInteger _auto_800_1, RogueClassCmdControlStructure* _auto_801_2 );
...
void RogueCmdNextIteration__write_java__JavaWriter_Logical( RogueClassCmdNextIteration* THIS, RogueClassJavaWriter* writer_0, RogueLogical is_statement_1 );
RogueClassCmdNextIteration* RogueCmdNextIteration__init_object( RogueClassCmdNextIteration* THIS );
RogueClassCmdNextIteration* RogueCmdNextIteration__init__Token_CmdControlStructure( RogueClassCmdNextIteration* THIS, RogueClassToken* _auto_802_0, RogueClassCmdControlStructure* _auto_803_1 );
...
void RogueCmdNecessary__write_java__JavaWriter_Logical( RogueClassCmdNecessary* THIS, RogueClassJavaWriter* writer_0, RogueLogical is_statement_1 );
RogueClassCmdNecessary* RogueCmdNecessary__init_object( RogueClassCmdNecessary* THIS );
RogueClassCmdNecessary* RogueCmdNecessary__init__Token_Cmd_CmdContingent( RogueClassCmdNecessary* THIS, RogueClassToken* _auto_804_0, RogueClassCmd* _auto_805_1, RogueClassCmdContingent* _auto_806_2 );
...
void RogueCmdSufficient__write_java__JavaWriter_Logical( RogueClassCmdSufficient* THIS, RogueClassJavaWriter* writer_0, RogueLogical is_statement_1 );
RogueClassCmdSufficient* RogueCmdSufficient__init_object( RogueClassCmdSufficient* THIS );
RogueClassCmdSufficient* RogueCmdSufficient__init__Token_Cmd_CmdContingent( RogueClassCmdSufficient* THIS, RogueClassToken* _auto_807_0, RogueClassCmd* _auto_808_1, RogueClassCmdContingent* _auto_809_2 );
...
RogueClassCmdAdjust* RogueCmdAdjust__init__Token_Cmd_Integer( RogueClassCmdAdjust* THIS, RogueClassToken* _auto_810_0, RogueClassCmd* _auto_811_1, RogueInteger _auto_812_2 );
...
RogueClassCmdOpWithAssign* RogueCmdOpWithAssign__init__Token_Cmd_TokenType_Cmd( RogueClassCmdOpWithAssign* THIS, RogueClassToken* _auto_813_0, RogueClassCmd* _auto_814_1, RogueClassTokenType* _auto_815_2, RogueClassCmd* _auto_816_3 );
...
RogueClassCmdWhichCase* RogueCmdWhichCase__init__Token_CmdArgs_CmdStatementList( RogueClassCmdWhichCase* THIS, RogueClassToken* _auto_817_0, RogueClassCmdArgs* _auto_818_1, RogueClassCmdStatementList* _auto_819_2 );
...
void RogueCmdCatch__write_java__JavaWriter_Logical( RogueClassCmdCatch* THIS, RogueClassJavaWriter* writer_0, RogueLogical is_statement_1 );
RogueClassCmdCatch* RogueCmdCatch__init_object( RogueClassCmdCatch* THIS );
RogueClassCmdCatch* RogueCmdCatch__init__Token_Local_CmdStatementList( RogueClassCmdCatch* THIS, RogueClassToken* _auto_821_0, RogueClassLocal* _auto_822_1, RogueClassCmdStatementList* _auto_823_2 );
...
void RogueCmdLocalDeclaration__write_java__JavaWriter_Logical( RogueClassCmdLocalDeclaration* THIS, RogueClassJavaWriter* writer_0, RogueLogical is_statement_1 );
RogueClassCmdLocalDeclaration* RogueCmdLocalDeclaration__init_object( RogueClassCmdLocalDeclaration* THIS );
RogueClassCmdLocalDeclaration* RogueCmdLocalDeclaration__init__Token_Local( RogueClassCmdLocalDeclaration* THIS, RogueClassToken* _auto_831_0, RogueClassLocal* _auto_832_1 );
...
void RogueCmdAdjustLocal__write_java__JavaWriter_Logical( RogueClassCmdAdjustLocal* THIS, RogueClassJavaWriter* writer_0, RogueLogical is_statement_1 );
RogueClassCmdAdjustLocal* RogueCmdAdjustLocal__init_object( RogueClassCmdAdjustLocal* THIS );
RogueClassCmdAdjustLocal* RogueCmdAdjustLocal__init__Token_Local_Integer( RogueClassCmdAdjustLocal* THIS, RogueClassToken* _auto_837_0, RogueClassLocal* _auto_838_1, RogueInteger _auto_839_2 );
...
void RogueCmdReadLocal__write_java__JavaWriter_Logical( RogueClassCmdReadLocal* THIS, RogueClassJavaWriter* writer_0, RogueLogical is_statement_1 );
RogueClassCmdReadLocal* RogueCmdReadLocal__init_object( RogueClassCmdReadLocal* THIS );
RogueClassCmdReadLocal* RogueCmdReadLocal__init__Token_Local( RogueClassCmdReadLocal* THIS, RogueClassToken* _auto_840_0, RogueClassLocal* _auto_841_1 );
...
RogueClassCmdRange* RogueCmdRange__init__Token_Cmd_Cmd_Cmd( RogueClassCmdRange* THIS, RogueClassToken* _auto_842_0, RogueClassCmd* _auto_843_1, RogueClassCmd* _auto_844_2, RogueClassCmd* _auto_845_3 );
...
void RogueCmdLocalOpWithAssign__write_java__JavaWriter_Logical( RogueClassCmdLocalOpWithAssign* THIS, RogueClassJavaWriter* writer_0, RogueLogical is_statement_1 );
RogueClassCmdLocalOpWithAssign* RogueCmdLocalOpWithAssign__init_object( RogueClassCmdLocalOpWithAssign* THIS );
RogueClassCmdLocalOpWithAssign* RogueCmdLocalOpWithAssign__init__Token_Local_TokenType_Cmd( RogueClassCmdLocalOpWithAssign* THIS, RogueClassToken* _auto_846_0, RogueClassLocal* _auto_847_1, RogueClassTokenType* _auto_848_2, RogueClassCmd* _auto_849_3 );
...
RogueString* RogueCmdResolvedOpWithAssign__java_symbol( RogueClassCmdResolvedOpWithAssign* THIS );
...
RogueClassCmdForEach* RogueCmdForEach__init__Token_String_String_Cmd_Cmd_CmdStatementList( RogueClassCmdForEach* THIS, RogueClassToken* _auto_850_0, RogueString* _auto_851_1, RogueString* _auto_852_2, RogueClassCmd* _auto_853_3, RogueClassCmd* _auto_854_4, RogueClassCmdStatementList* _auto_855_5 );
...
RogueString* RogueCmdLogicalXor__java_symbol( RogueClassCmdLogicalXor* THIS );
...
RogueString* RogueCmdLogicalOr__java_symbol( RogueClassCmdLogicalOr* THIS );
...
RogueString* RogueCmdLogicalAnd__java_symbol( RogueClassCmdLogicalAnd* THIS );
...
RogueString* RogueCmdCompareIs__java_symbol( RogueClassCmdCompareIs* THIS );
...
RogueString* RogueCmdCompareIsNot__java_symbol( RogueClassCmdCompareIsNot* THIS );
...
void RogueCmdInstanceOf__write_java__JavaWriter_Logical( RogueClassCmdInstanceOf* THIS, RogueClassJavaWriter* writer_0, RogueLogical is_statement_1 );
...
RogueString* RogueCmdLogicalNot__java_prefix_symbol( RogueClassCmdLogicalNot* THIS );
...
RogueString* RogueCmdBitwiseXor__java_symbol( RogueClassCmdBitwiseXor* THIS );
...
RogueString* RogueCmdBitwiseShiftLeft__java_symbol( RogueClassCmdBitwiseShiftLeft* THIS );
...
RogueString* RogueCmdBitwiseShiftRightX__java_symbol( RogueClassCmdBitwiseShiftRightX* THIS );
...
void RogueCmdPower__write_java__JavaWriter_Logical( RogueClassCmdPower* THIS, RogueClassJavaWriter* writer_0, RogueLogical is_statement_1 );
...
RogueString* RogueCmdBitwiseNot__java_prefix_symbol( RogueClassCmdBitwiseNot* THIS );
...
void RogueCmdGetOptionalValue__write_java__JavaWriter_Logical( RogueClassCmdGetOptionalValue* THIS, RogueClassJavaWriter* writer_0, RogueLogical is_statement_1 );
RogueClassCmdGetOptionalValue* RogueCmdGetOptionalValue__init_object( RogueClassCmdGetOptionalValue* THIS );
RogueClassCmdGetOptionalValue* RogueCmdGetOptionalValue__init__Token_Cmd( RogueClassCmdGetOptionalValue* THIS, RogueClassToken* _auto_856_0, RogueClassCmd* _auto_857_1 );
...
RogueClassCmdElementAccess* RogueCmdElementAccess__init__Token_Cmd_Cmd( RogueClassCmdElementAccess* THIS, RogueClassToken* _auto_858_0, RogueClassCmd* _auto_859_1, RogueClassCmd* _auto_860_2 );
...
RogueClassCmdCreateCallback* RogueCmdCreateCallback__init__Token_Cmd_String_String_Type( RogueClassCmdCreateCallback* THIS, RogueClassToken* _auto_861_0, RogueClassCmd* _auto_862_1, RogueString* _auto_863_2, RogueString* _auto_864_3, RogueClassType* _auto_865_4 );
...
void RogueCmdAs__write_java__JavaWriter_Logical( RogueClassCmdAs* THIS, RogueClassJavaWriter* writer_0, RogueLogical is_statement_1 );
...
RogueClassCmdDefaultValue* RogueCmdDefaultValue__init__Token_Type( RogueClassCmdDefaultValue* THIS, RogueClassToken* _auto_866_0, RogueClassType* _auto_867_1 );
...
RogueClassCmdFormattedString* RogueCmdFormattedString__init__Token_String_CmdArgs( RogueClassCmdFormattedString* THIS, RogueClassToken* _auto_869_0, RogueString* _auto_870_1, RogueClassCmdArgs* _auto_871_2 );
...
void RogueCmdLiteralReal__write_java__JavaWriter_Logical( RogueClassCmdLiteralReal* THIS, RogueClassJavaWriter* writer_0, RogueLogical is_statement_1 );
RogueClassCmdLiteralReal* RogueCmdLiteralReal__init_object( RogueClassCmdLiteralReal* THIS );
RogueClassCmdLiteralReal* RogueCmdLiteralReal__init__Token_Real( RogueClassCmdLiteralReal* THIS, RogueClassToken* _auto_872_0, RogueReal _auto_873_1 );
...
void RogueCmdLiteralLong__write_java__JavaWriter_Logical( RogueClassCmdLiteralLong* THIS, RogueClassJavaWriter* writer_0, RogueLogical is_statement_1 );
RogueClassCmdLiteralLong* RogueCmdLiteralLong__init_object( RogueClassCmdLiteralLong* THIS );
RogueClassCmdLiteralLong* RogueCmdLiteralLong__init__Token_Long( RogueClassCmdLiteralLong* THIS, RogueClassToken* _auto_874_0, RogueLong _auto_875_1 );
...
void RogueCmdLiteralCharacter__write_java__JavaWriter_Logical( RogueClassCmdLiteralCharacter* THIS, RogueClassJavaWriter* writer_0, RogueLogical is_statement_1 );
RogueClassCmdLiteralCharacter* RogueCmdLiteralCharacter__init_object( RogueClassCmdLiteralCharacter* THIS );
RogueClassCmdLiteralCharacter* RogueCmdLiteralCharacter__init__Token_Character( RogueClassCmdLiteralCharacter* THIS, RogueClassToken* _auto_876_0, RogueCharacter _auto_877_1 );
...
RogueClassCmdCreateList* RogueCmdCreateList__init__Token_CmdArgs_Type( RogueClassCmdCreateList* THIS, RogueClassToken* _auto_878_0, RogueClassCmdArgs* _auto_879_1, RogueClassType* _auto_880_2 );
...
RogueClassCmdCallPriorMethod* RogueCmdCallPriorMethod__init__Token_String_CmdArgs( RogueClassCmdCallPriorMethod* THIS, RogueClassToken* _auto_881_0, RogueString* _auto_882_1, RogueClassCmdArgs* _auto_883_2 );
...
RogueClassFnParam* RogueFnParam__init__String( RogueClassFnParam* THIS, RogueString* _auto_884_0 );
...
RogueClassFnArg* RogueFnArg__init__String_Cmd( RogueClassFnArg* THIS, RogueString* _auto_886_0, RogueClassCmd* _auto_887_1 );
RogueClassFnArg* RogueFnArg__set_type__Type( RogueClassFnArg* THIS, RogueClassType* _auto_888_0 );
...
RogueClassCmdCreateFunction* RogueCmdCreateFunction__init__Token_FnParamList_Type_FnArgList_CmdStatementList( RogueClassCmdCreateFunction* THIS, RogueClassToken* _auto_890_0, RogueFnParamList* _auto_891_1, RogueClassType* _auto_892_2, RogueFnArgList* _auto_893_3, RogueClassCmdStatementList* _auto_894_4 );
...
void RogueCmdNativeCode__write_java__JavaWriter_Logical( RogueClassCmdNativeCode* THIS, RogueClassJavaWriter* writer_0, RogueLogical is_statement_1 );
RogueClassCmdNativeCode* RogueCmdNativeCode__init_object( RogueClassCmdNativeCode* THIS );
RogueClassCmdNativeCode* RogueCmdNativeCode__init__Token_String_Type( RogueClassCmdNativeCode* THIS, RogueClassToken* _auto_895_0, RogueString* _auto_896_1, RogueClassType* _auto_897_2 );
...
RogueClassMacroArgs* RogueMacroArgs__init__Cmd_Method_CmdArgs( RogueClassMacroArgs* THIS, RogueClassCmd* _auto_970_0, RogueClassMethod* _auto_971_1, RogueClassCmdArgs* args_2 );
...
void RogueCmdReadSingleton__write_java__JavaWriter_Logical( RogueClassCmdReadSingleton* THIS, RogueClassJavaWriter* writer_0, RogueLogical is_statement_1 );
RogueClassCmdReadSingleton* RogueCmdReadSingleton__init_object( RogueClassCmdReadSingleton* THIS );
RogueClassCmdReadSingleton* RogueCmdReadSingleton__init__Token_Type( RogueClassCmdReadSingleton* THIS, RogueClassToken* _auto_972_0, RogueClassType* _auto_973_1 );
...
void RogueCmdCreateArray__write_java__JavaWriter_Logical( RogueClassCmdCreateArray* THIS, RogueClassJavaWriter* writer_0, RogueLogical is_statement_1 );
RogueClassCmdCreateArray* RogueCmdCreateArray__init_object( RogueClassCmdCreateArray* THIS );
RogueClassCmdCreateArray* RogueCmdCreateArray__init__Token_Type_CmdArgs( RogueClassCmdCreateArray* THIS, RogueClassToken* _auto_974_0, RogueClassType* _auto_975_1, RogueClassCmdArgs* args_2 );
RogueClassCmdCreateArray* RogueCmdCreateArray__init__Token_Type_Cmd( RogueClassCmdCreateArray* THIS, RogueClassToken* _auto_976_0, RogueClassType* _auto_977_1, RogueClassCmd* _auto_978_2 );
...
void RogueCmdCallRoutine__write_java__JavaWriter_Logical( RogueClassCmdCallRoutine* THIS, RogueClassJavaWriter* writer_0, RogueLogical is_statement_1 );
RogueClassCmdCallRoutine* RogueCmdCallRoutine__init_object( RogueClassCmdCallRoutine* THIS );
RogueClassCmdCallRoutine* RogueCmdCallRoutine__init__Token_Method_CmdArgs( RogueClassCmdCallRoutine* THIS, RogueClassToken* _auto_983_0, RogueClassMethod* _auto_984_1, RogueClassCmdArgs* _auto_985_2 );
...
RogueClassCmdCall* RogueCmdCall__init__Token_Cmd_Method_CmdArgs( RogueClassCmdCall* THIS, RogueClassToken* _auto_979_0, RogueClassCmd* _auto_980_1, RogueClassMethod* _auto_981_2, RogueClassCmdArgs* _auto_982_3 );
...
void RogueCmdCreateObject__write_java__JavaWriter_Logical( RogueClassCmdCreateObject* THIS, RogueClassJavaWriter* writer_0, RogueLogical is_statement_1 );
RogueClassCmdCreateObject* RogueCmdCreateObject__init_object( RogueClassCmdCreateObject* THIS );
RogueClassCmdCreateObject* RogueCmdCreateObject__init__Token_Type( RogueClassCmdCreateObject* THIS, RogueClassToken* _auto_986_0, RogueClassType* _auto_987_1 );
...
void RogueCmdReadGlobal__write_java__JavaWriter_Logical( RogueClassCmdReadGlobal* THIS, RogueClassJavaWriter* writer_0, RogueLogical is_statement_1 );
RogueClassCmdReadGlobal* RogueCmdReadGlobal__init_object( RogueClassCmdReadGlobal* THIS );
RogueClassCmdReadGlobal* RogueCmdReadGlobal__init__Token_Property( RogueClassCmdReadGlobal* THIS, RogueClassToken* _auto_988_0, RogueClassProperty* _auto_989_1 );
...
void RogueCmdReadProperty__write_java__JavaWriter_Logical( RogueClassCmdReadProperty* THIS, RogueClassJavaWriter* writer_0, RogueLogical is_statement_1 );
RogueClassCmdReadProperty* RogueCmdReadProperty__init_object( RogueClassCmdReadProperty* THIS );
RogueClassCmdReadProperty* RogueCmdReadProperty__init__Token_Cmd_Property( RogueClassCmdReadProperty* THIS, RogueClassToken* _auto_990_0, RogueClassCmd* _auto_991_1, RogueClassProperty* _auto_992_2 );
...
void RogueCmdLogicalizeOptionalValue__write_java__JavaWriter_Logical( RogueClassCmdLogicalizeOptionalValue* THIS, RogueClassJavaWriter* writer_0, RogueLogical is_statement_1 );
...
RogueClassCmdLogicalizeOptionalValue* RogueCmdLogicalizeOptionalValue__init__Token_Cmd_Logical( RogueClassCmdLogicalizeOptionalValue* THIS, RogueClassToken* _auto_993_0, RogueClassCmd* _auto_994_1, RogueLogical _auto_995_2 );
...
void RogueCmdWriteLocal__write_java__JavaWriter_Logical( RogueClassCmdWriteLocal* THIS, RogueClassJavaWriter* writer_0, RogueLogical is_statement_1 );
RogueClassCmdWriteLocal* RogueCmdWriteLocal__init_object( RogueClassCmdWriteLocal* THIS );
RogueClassCmdWriteLocal* RogueCmdWriteLocal__init__Token_Local_Cmd( RogueClassCmdWriteLocal* THIS, RogueClassToken* _auto_997_0, RogueClassLocal* _auto_998_1, RogueClassCmd* _auto_999_2 );
...
void RogueCmdOpAssignGlobal__write_java__JavaWriter_Logical( RogueClassCmdOpAssignGlobal* THIS, RogueClassJavaWriter* writer_0, RogueLogical is_statement_1 );
RogueClassCmdOpAssignGlobal* RogueCmdOpAssignGlobal__init_object( RogueClassCmdOpAssignGlobal* THIS );
RogueClassCmdOpAssignGlobal* RogueCmdOpAssignGlobal__init__Token_Property_TokenType_Cmd( RogueClassCmdOpAssignGlobal* THIS, RogueClassToken* _auto_1000_0, RogueClassProperty* _auto_1001_1, RogueClassTokenType* _auto_1002_2, RogueClassCmd* _auto_1003_3 );
...
void RogueCmdOpAssignProperty__write_java__JavaWriter_Logical( RogueClassCmdOpAssignProperty* THIS, RogueClassJavaWriter* writer_0, RogueLogical is_statement_1 );
RogueClassCmdOpAssignProperty* RogueCmdOpAssignProperty__init_object( RogueClassCmdOpAssignProperty* THIS );
RogueClassCmdOpAssignProperty* RogueCmdOpAssignProperty__init__Token_Cmd_Property_TokenType_Cmd( RogueClassCmdOpAssignProperty* THIS, RogueClassToken* _auto_1004_0, RogueClassCmd* _auto_1005_1, RogueClassProperty* _auto_1006_2, RogueClassTokenType* _auto_1007_3, RogueClassCmd* _auto_1008_4 );
...
RogueClassCmdCallInlineNativeRoutine* RogueCmdCallInlineNativeRoutine__init__Token_Method_CmdArgs( RogueClassCmdCallInlineNativeRoutine* THIS, RogueClassToken* _auto_1019_0, RogueClassMethod* _auto_1020_1, RogueClassCmdArgs* _auto_1021_2 );
...
void RogueCmdCallInlineNative__write_java__JavaWriter_Logical( RogueClassCmdCallInlineNative* THIS, RogueClassJavaWriter* writer_0, RogueLogical is_statement_1 );
...
void RogueCmdCallInlineNative__print_this__JavaWriter( RogueClassCmdCallInlineNative* THIS, RogueClassJavaWriter* writer_0 );
...
void RogueCmdCallNativeRoutine__write_java__JavaWriter_Logical( RogueClassCmdCallNativeRoutine* THIS, RogueClassJavaWriter* writer_0, RogueLogical is_statement_1 );
RogueClassCmdCallNativeRoutine* RogueCmdCallNativeRoutine__init_object( RogueClassCmdCallNativeRoutine* THIS );
RogueClassCmdCallNativeRoutine* RogueCmdCallNativeRoutine__init__Token_Method_CmdArgs( RogueClassCmdCallNativeRoutine* THIS, RogueClassToken* _auto_1022_0, RogueClassMethod* _auto_1023_1, RogueClassCmdArgs* _auto_1024_2 );
...
void RogueCmdReadArrayCount__write_java__JavaWriter_Logical( RogueClassCmdReadArrayCount* THIS, RogueClassJavaWriter* writer_0, RogueLogical is_statement_1 );
RogueClassCmdReadArrayCount* RogueCmdReadArrayCount__init_object( RogueClassCmdReadArrayCount* THIS );
RogueClassCmdReadArrayCount* RogueCmdReadArrayCount__init__Token_Cmd( RogueClassCmdReadArrayCount* THIS, RogueClassToken* _auto_1027_0, RogueClassCmd* _auto_1028_1 );
...
void RogueCmdCallInlineNativeMethod__print_this__JavaWriter( RogueClassCmdCallInlineNativeMethod* THIS, RogueClassJavaWriter* writer_0 );
...
void RogueCmdCallNativeMethod__write_java__JavaWriter_Logical( RogueClassCmdCallNativeMethod* THIS, RogueClassJavaWriter* writer_0, RogueLogical is_statement_1 );
...
void RogueCmdCallAspectMethod__write_java__JavaWriter_Logical( RogueClassCmdCallAspectMethod* THIS, RogueClassJavaWriter* writer_0, RogueLogical is_statement_1 );
...
void RogueCmdCallDynamicMethod__write_java__JavaWriter_Logical( RogueClassCmdCallDynamicMethod* THIS, RogueClassJavaWriter* writer_0, RogueLogical is_statement_1 );
...
RogueClassCandidateMethods* RogueCandidateMethods__init__Type_CmdAccess_Logical( RogueClassCandidateMethods* THIS, RogueClassType* _auto_1032_0, RogueClassCmdAccess* _auto_1033_1, RogueLogical _auto_1034_2 );
...
void RogueCmdBlock__write_java__JavaWriter_Logical( RogueClassCmdBlock* THIS, RogueClassJavaWriter* writer_0, RogueLogical is_statement_1 );
RogueClassCmdBlock* RogueCmdBlock__init_object( RogueClassCmdBlock* THIS );
RogueClassCmdBlock* RogueCmdBlock__init__Token_Integer( RogueClassCmdBlock* THIS, RogueClassToken* _auto_1089_0, RogueInteger _auto_1090_1 );
RogueClassCmdBlock* RogueCmdBlock__init__Token_CmdStatementList_Integer( RogueClassCmdBlock* THIS, RogueClassToken* _auto_1091_0, RogueClassCmdStatementList* _auto_1092_1, RogueInteger _auto_1093_2 );
...
RogueClassEOLToken* RogueEOLToken__init__TokenType_String( RogueClassEOLToken* THIS, RogueClassTokenType* _auto_1169_0, RogueString* _auto_1170_1 );
...
RogueClassPreprocessorTokenReader* RoguePreprocessorTokenReader__init__TokenList( RogueClassPreprocessorTokenReader* THIS, RogueTokenList* _auto_1185_0 );
...
void RogueCmdSwitch__write_java__JavaWriter_Logical( RogueClassCmdSwitch* THIS, RogueClassJavaWriter* writer_0, RogueLogical is_statement_1 );
RogueClassCmdSwitch* RogueCmdSwitch__init_object( RogueClassCmdSwitch* THIS );
RogueClassCmdSwitch* RogueCmdSwitch__init__Token_Cmd_CmdWhichCaseList_CmdWhichCase_Integer( RogueClassCmdSwitch* THIS, RogueClassToken* _auto_1199_0, RogueClassCmd* _auto_1200_1, RogueCmdWhichCaseList* _auto_1201_2, RogueClassCmdWhichCase* _auto_1202_3, RogueInteger _auto_1203_4 );
...
void RogueCmdReadArrayElement__write_java__JavaWriter_Logical( RogueClassCmdReadArrayElement* THIS, RogueClassJavaWriter* writer_0, RogueLogical is_statement_1 );
RogueClassCmdReadArrayElement* RogueCmdReadArrayElement__init_object( RogueClassCmdReadArrayElement* THIS );
RogueClassCmdReadArrayElement* RogueCmdReadArrayElement__init__Token_Cmd_Cmd( RogueClassCmdReadArrayElement* THIS, RogueClassToken* _auto_1250_0, RogueClassCmd* _auto_1251_1, RogueClassCmd* _auto_1252_2 );
...
void RogueCmdWriteArrayElement__write_java__JavaWriter_Logical( RogueClassCmdWriteArrayElement* THIS, RogueClassJavaWriter* writer_0, RogueLogical is_statement_1 );
RogueClassCmdWriteArrayElement* RogueCmdWriteArrayElement__init_object( RogueClassCmdWriteArrayElement* THIS );
RogueClassCmdWriteArrayElement* RogueCmdWriteArrayElement__init__Token_Cmd_Cmd_Cmd( RogueClassCmdWriteArrayElement* THIS, RogueClassToken* _auto_1253_0, RogueClassCmd* _auto_1254_1, RogueClassCmd* _auto_1255_2, RogueClassCmd* _auto_1256_3 );
...
void RogueCmdConvertToPrimitiveType__write_java__JavaWriter_Logical( RogueClassCmdConvertToPrimitiveType* THIS, RogueClassJavaWriter* writer_0, RogueLogical is_statement_1 );
...
void RogueCmdAdjustProperty__write_java__JavaWriter_Logical( RogueClassCmdAdjustProperty* THIS, RogueClassJavaWriter* writer_0, RogueLogical is_statement_1 );
RogueClassCmdAdjustProperty* RogueCmdAdjustProperty__init_object( RogueClassCmdAdjustProperty* THIS );
RogueClassCmdAdjustProperty* RogueCmdAdjustProperty__init__Token_Cmd_Property_Integer( RogueClassCmdAdjustProperty* THIS, RogueClassToken* _auto_1340_0, RogueClassCmd* _auto_1341_1, RogueClassProperty* _auto_1342_2, RogueInteger _auto_1343_3 );
...
void RogueCmdCallStaticMethod__write_java__JavaWriter_Logical( RogueClassCmdCallStaticMethod* THIS, RogueClassJavaWriter* writer_0, RogueLogical is_statement_1 );
