...
RogueClassParseReader* RogueParseReader__init__ByteList( RogueClassParseReader* THIS, RogueByteList* source_0 );
RogueClassParseReader* RogueParseReader__init__CharacterList( RogueClassParseReader* THIS, RogueCharacterList* source_0 );
...
RogueClassParseReader* RogueParseReader__set_position__Integer_Integer( RogueClassParseReader* THIS, RogueInteger _auto_704_0, RogueInteger _auto_705_1 );
...
RogueTokenList* RoguePreprocessor__process__TokenList( RogueClassPreprocessor* THIS, RogueTokenList* _auto_706_0 );
...
RogueClassCmdIf* RogueCmdIf__init__Token_Cmd_Integer( RogueClassCmdIf* THIS, RogueClassToken* _auto_713_0, RogueClassCmd* _auto_714_1, RogueInteger _auto_715_2 );
RogueClassCmdIf* RogueCmdIf__init__Token_Cmd_CmdStatementList_Integer( RogueClassCmdIf* THIS, RogueClassToken* _auto_716_0, RogueClassCmd* _auto_717_1, RogueClassCmdStatementList* _auto_718_2, RogueInteger _auto_719_3 );
...
RogueClassCmdWhich* RogueCmdWhich__init__Token_Cmd_CmdWhichCaseList_CmdWhichCase_Integer( RogueClassCmdWhich* THIS, RogueClassToken* _auto_720_0, RogueClassCmd* _auto_721_1, RogueCmdWhichCaseList* _auto_722_2, RogueClassCmdWhichCase* _auto_723_3, RogueInteger _auto_724_4 );
...
RogueClassCmdContingent* RogueCmdContingent__init__Token_CmdStatementList( RogueClassCmdContingent* THIS, RogueClassToken* _auto_725_0, RogueClassCmdStatementList* _auto_726_1 );
...
RogueClassCmdTry* RogueCmdTry__init__Token_CmdStatementList_CmdCatchList( RogueClassCmdTry* THIS, RogueClassToken* _auto_727_0, RogueClassCmdStatementList* _auto_728_1, RogueCmdCatchList* _auto_729_2 );
...
RogueClassCmdAwait* RogueCmdAwait__init__Token_Cmd_CmdStatementList_Local( RogueClassCmdAwait* THIS, RogueClassToken* _auto_730_0, RogueClassCmd* _auto_731_1, RogueClassCmdStatementList* _auto_732_2, RogueClassLocal* _auto_733_3 );
...
RogueClassCmdYield* RogueCmdYield__init__Token( RogueClassCmdYield* THIS, RogueClassToken* _auto_734_0 );
...
RogueClassCmdThrow* RogueCmdThrow__init__Token_Cmd( RogueClassCmdThrow* THIS, RogueClassToken* _auto_735_0, RogueClassCmd* _auto_736_1 );
...
RogueClassCmdTrace* RogueCmdTrace__init__Token_String( RogueClassCmdTrace* THIS, RogueClassToken* _auto_737_0, RogueString* _auto_738_1 );
...
RogueClassCmdEscape* RogueCmdEscape__init__Token_Integer_CmdControlStructure( RogueClassCmdEscape* THIS, RogueClassToken* _auto_739_0, RogueInteger _auto_740_1, RogueClassCmdControlStructure* _auto_741_2 );
...
RogueClassCmdNextIteration* RogueCmdNextIteration__init__Token_CmdControlStructure( RogueClassCmdNextIteration* THIS, RogueClassToken* _auto_742_0, RogueClassCmdControlStructure* _auto_743_1 );
...
RogueClassCmdNecessary* RogueCmdNecessary__init__Token_Cmd_CmdContingent( RogueClassCmdNecessary* THIS, RogueClassToken* _auto_744_0, RogueClassCmd* _auto_745_1, RogueClassCmdContingent* _auto_746_2 );
...
RogueClassCmdSufficient* RogueCmdSufficient__init__Token_Cmd_CmdContingent( RogueClassCmdSufficient* THIS, RogueClassToken* _auto_747_0, RogueClassCmd* _auto_748_1, RogueClassCmdContingent* _auto_749_2 );
...
RogueClassCmdAdjust* RogueCmdAdjust__init__Token_Cmd_Integer( RogueClassCmdAdjust* THIS, RogueClassToken* _auto_750_0, RogueClassCmd* _auto_751_1, RogueInteger _auto_752_2 );
...
RogueClassCmdOpWithAssign* RogueCmdOpWithAssign__init__Token_Cmd_TokenType_Cmd( RogueClassCmdOpWithAssign* THIS, RogueClassToken* _auto_753_0, RogueClassCmd* _auto_754_1, RogueClassTokenType* _auto_755_2, RogueClassCmd* _auto_756_3 );
...
RogueClassCmdWhichCase* RogueCmdWhichCase__init__Token_CmdArgs_CmdStatementList( RogueClassCmdWhichCase* THIS, RogueClassToken* _auto_757_0, RogueClassCmdArgs* _auto_758_1, RogueClassCmdStatementList* _auto_759_2 );
...
RogueClassCmdCatch* RogueCmdCatch__init__Token_Local_CmdStatementList( RogueClassCmdCatch* THIS, RogueClassToken* _auto_761_0, RogueClassLocal* _auto_762_1, RogueClassCmdStatementList* _auto_763_2 );
...
RogueClassCmdLocalDeclaration* RogueCmdLocalDeclaration__init__Token_Local( RogueClassCmdLocalDeclaration* THIS, RogueClassToken* _auto_771_0, RogueClassLocal* _auto_772_1 );
...
RogueClassCmdAdjustLocal* RogueCmdAdjustLocal__init__Token_Local_Integer( RogueClassCmdAdjustLocal* THIS, RogueClassToken* _auto_777_0, RogueClassLocal* _auto_778_1, RogueInteger _auto_779_2 );
...
RogueClassCmdReadLocal* RogueCmdReadLocal__init__Token_Local( RogueClassCmdReadLocal* THIS, RogueClassToken* _auto_780_0, RogueClassLocal* _auto_781_1 );
...
RogueClassCmdRange* RogueCmdRange__init__Token_Cmd_Cmd_Cmd( RogueClassCmdRange* THIS, RogueClassToken* _auto_782_0, RogueClassCmd* _auto_783_1, RogueClassCmd* _auto_784_2, RogueClassCmd* _auto_785_3 );
...
RogueClassCmdLocalOpWithAssign* RogueCmdLocalOpWithAssign__init__Token_Local_TokenType_Cmd( RogueClassCmdLocalOpWithAssign* THIS, RogueClassToken* _auto_786_0, RogueClassLocal* _auto_787_1, RogueClassTokenType* _auto_788_2, RogueClassCmd* _auto_789_3 );
...
RogueClassCmdForEach* RogueCmdForEach__init__Token_String_String_Cmd_Cmd_CmdStatementList( RogueClassCmdForEach* THIS, RogueClassToken* _auto_790_0, RogueString* _auto_791_1, RogueString* _auto_792_2, RogueClassCmd* _auto_793_3, RogueClassCmd* _auto_794_4, RogueClassCmdStatementList* _auto_795_5 );
...
RogueClassCmdGetOptionalValue* RogueCmdGetOptionalValue__init__Token_Cmd( RogueClassCmdGetOptionalValue* THIS, RogueClassToken* _auto_796_0, RogueClassCmd* _auto_797_1 );
...
RogueClassCmdElementAccess* RogueCmdElementAccess__init__Token_Cmd_Cmd( RogueClassCmdElementAccess* THIS, RogueClassToken* _auto_798_0, RogueClassCmd* _auto_799_1, RogueClassCmd* _auto_800_2 );
...
RogueClassCmdCreateCallback* RogueCmdCreateCallback__init__Token_Cmd_String_String_Type( RogueClassCmdCreateCallback* THIS, RogueClassToken* _auto_801_0, RogueClassCmd* _auto_802_1, RogueString* _auto_803_2, RogueString* _auto_804_3, RogueClassType* _auto_805_4 );
...
RogueClassCmdDefaultValue* RogueCmdDefaultValue__init__Token_Type( RogueClassCmdDefaultValue* THIS, RogueClassToken* _auto_806_0, RogueClassType* _auto_807_1 );
...
RogueClassCmdFormattedString* RogueCmdFormattedString__init__Token_String_CmdArgs( RogueClassCmdFormattedString* THIS, RogueClassToken* _auto_809_0, RogueString* _auto_810_1, RogueClassCmdArgs* _auto_811_2 );
...
RogueClassCmdLiteralReal* RogueCmdLiteralReal__init__Token_Real( RogueClassCmdLiteralReal* THIS, RogueClassToken* _auto_812_0, RogueReal _auto_813_1 );
...
RogueClassCmdLiteralLong* RogueCmdLiteralLong__init__Token_Long( RogueClassCmdLiteralLong* THIS, RogueClassToken* _auto_814_0, RogueLong _auto_815_1 );
...
RogueClassCmdLiteralCharacter* RogueCmdLiteralCharacter__init__Token_Character( RogueClassCmdLiteralCharacter* THIS, RogueClassToken* _auto_816_0, RogueCharacter _auto_817_1 );
...
RogueClassCmdCreateList* RogueCmdCreateList__init__Token_CmdArgs_Type( RogueClassCmdCreateList* THIS, RogueClassToken* _auto_818_0, RogueClassCmdArgs* _auto_819_1, RogueClassType* _auto_820_2 );
...
RogueClassCmdCallPriorMethod* RogueCmdCallPriorMethod__init__Token_String_CmdArgs( RogueClassCmdCallPriorMethod* THIS, RogueClassToken* _auto_821_0, RogueString* _auto_822_1, RogueClassCmdArgs* _auto_823_2 );
...
RogueClassFnParam* RogueFnParam__init__String( RogueClassFnParam* THIS, RogueString* _auto_824_0 );
...
RogueClassFnArg* RogueFnArg__init__String_Cmd( RogueClassFnArg* THIS, RogueString* _auto_826_0, RogueClassCmd* _auto_827_1 );
RogueClassFnArg* RogueFnArg__set_type__Type( RogueClassFnArg* THIS, RogueClassType* _auto_828_0 );
...
RogueClassCmdCreateFunction* RogueCmdCreateFunction__init__Token_FnParamList_Type_FnArgList_CmdStatementList( RogueClassCmdCreateFunction* THIS, RogueClassToken* _auto_830_0, RogueFnParamList* _auto_831_1, RogueClassType* _auto_832_2, RogueFnArgList* _auto_833_3, RogueClassCmdStatementList* _auto_834_4 );
...
RogueClassCmdNativeCode* RogueCmdNativeCode__init__Token_String_Type( RogueClassCmdNativeCode* THIS, RogueClassToken* _auto_835_0, RogueString* _auto_836_1, RogueClassType* _auto_837_2 );
...
RogueClassMacroArgs* RogueMacroArgs__init__Cmd_Method_CmdArgs( RogueClassMacroArgs* THIS, RogueClassCmd* _auto_910_0, RogueClassMethod* _auto_911_1, RogueClassCmdArgs* args_2 );
...
RogueClassCmdReadSingleton* RogueCmdReadSingleton__init__Token_Type( RogueClassCmdReadSingleton* THIS, RogueClassToken* _auto_912_0, RogueClassType* _auto_913_1 );
...
RogueClassCmdCreateArray* RogueCmdCreateArray__init__Token_Type_CmdArgs( RogueClassCmdCreateArray* THIS, RogueClassToken* _auto_914_0, RogueClassType* _auto_915_1, RogueClassCmdArgs* args_2 );
RogueClassCmdCreateArray* RogueCmdCreateArray__init__Token_Type_Cmd( RogueClassCmdCreateArray* THIS, RogueClassToken* _auto_916_0, RogueClassType* _auto_917_1, RogueClassCmd* _auto_918_2 );
...
RogueClassCmdCallRoutine* RogueCmdCallRoutine__init__Token_Method_CmdArgs( RogueClassCmdCallRoutine* THIS, RogueClassToken* _auto_923_0, RogueClassMethod* _auto_924_1, RogueClassCmdArgs* _auto_925_2 );
...
RogueClassCmdCall* RogueCmdCall__init__Token_Cmd_Method_CmdArgs( RogueClassCmdCall* THIS, RogueClassToken* _auto_919_0, RogueClassCmd* _auto_920_1, RogueClassMethod* _auto_921_2, RogueClassCmdArgs* _auto_922_3 );
...
RogueClassCmdCreateObject* RogueCmdCreateObject__init__Token_Type( RogueClassCmdCreateObject* THIS, RogueClassToken* _auto_926_0, RogueClassType* _auto_927_1 );
...
RogueClassCmdReadGlobal* RogueCmdReadGlobal__init__Token_Property( RogueClassCmdReadGlobal* THIS, RogueClassToken* _auto_928_0, RogueClassProperty* _auto_929_1 );
...
RogueClassCmdReadProperty* RogueCmdReadProperty__init__Token_Cmd_Property( RogueClassCmdReadProperty* THIS, RogueClassToken* _auto_930_0, RogueClassCmd* _auto_931_1, RogueClassProperty* _auto_932_2 );
...
RogueClassCmdLogicalizeOptionalValue* RogueCmdLogicalizeOptionalValue__init__Token_Cmd_Logical( RogueClassCmdLogicalizeOptionalValue* THIS, RogueClassToken* _auto_933_0, RogueClassCmd* _auto_934_1, RogueLogical _auto_935_2 );
...
RogueClassCmdWriteLocal* RogueCmdWriteLocal__init__Token_Local_Cmd( RogueClassCmdWriteLocal* THIS, RogueClassToken* _auto_937_0, RogueClassLocal* _auto_938_1, RogueClassCmd* _auto_939_2 );
...
RogueClassCmdOpAssignGlobal* RogueCmdOpAssignGlobal__init__Token_Property_TokenType_Cmd( RogueClassCmdOpAssignGlobal* THIS, RogueClassToken* _auto_940_0, RogueClassProperty* _auto_941_1, RogueClassTokenType* _auto_942_2, RogueClassCmd* _auto_943_3 );
...
RogueClassCmdOpAssignProperty* RogueCmdOpAssignProperty__init__Token_Cmd_Property_TokenType_Cmd( RogueClassCmdOpAssignProperty* THIS, RogueClassToken* _auto_944_0, RogueClassCmd* _auto_945_1, RogueClassProperty* _auto_946_2, RogueClassTokenType* _auto_947_3, RogueClassCmd* _auto_948_4 );
...
RogueClassCmdCallInlineNativeRoutine* RogueCmdCallInlineNativeRoutine__init__Token_Method_CmdArgs( RogueClassCmdCallInlineNativeRoutine* THIS, RogueClassToken* _auto_959_0, RogueClassMethod* _auto_960_1, RogueClassCmdArgs* _auto_961_2 );
...
RogueClassCmdCallNativeRoutine* RogueCmdCallNativeRoutine__init__Token_Method_CmdArgs( RogueClassCmdCallNativeRoutine* THIS, RogueClassToken* _auto_962_0, RogueClassMethod* _auto_963_1, RogueClassCmdArgs* _auto_964_2 );
...
RogueClassCmdReadArrayCount* RogueCmdReadArrayCount__init__Token_Cmd( RogueClassCmdReadArrayCount* THIS, RogueClassToken* _auto_967_0, RogueClassCmd* _auto_968_1 );
...
RogueClassCandidateMethods* RogueCandidateMethods__init__Type_CmdAccess_Logical( RogueClassCandidateMethods* THIS, RogueClassType* _auto_972_0, RogueClassCmdAccess* _auto_973_1, RogueLogical _auto_974_2 );
...
RogueClassCmdBlock* RogueCmdBlock__init__Token_Integer( RogueClassCmdBlock* THIS, RogueClassToken* _auto_1029_0, RogueInteger _auto_1030_1 );
RogueClassCmdBlock* RogueCmdBlock__init__Token_CmdStatementList_Integer( RogueClassCmdBlock* THIS, RogueClassToken* _auto_1031_0, RogueClassCmdStatementList* _auto_1032_1, RogueInteger _auto_1033_2 );
...
RogueClassEOLToken* RogueEOLToken__init__TokenType_String( RogueClassEOLToken* THIS, RogueClassTokenType* _auto_1109_0, RogueString* _auto_1110_1 );
...
RogueClassPreprocessorTokenReader* RoguePreprocessorTokenReader__init__TokenList( RogueClassPreprocessorTokenReader* THIS, RogueTokenList* _auto_1129_0 );
...
RogueClassCmdSwitch* RogueCmdSwitch__init__Token_Cmd_CmdWhichCaseList_CmdWhichCase_Integer( RogueClassCmdSwitch* THIS, RogueClassToken* _auto_1143_0, RogueClassCmd* _auto_1144_1, RogueCmdWhichCaseList* _auto_1145_2, RogueClassCmdWhichCase* _auto_1146_3, RogueInteger _auto_1147_4 );
...
RogueClassCmdReadArrayElement* RogueCmdReadArrayElement__init__Token_Cmd_Cmd( RogueClassCmdReadArrayElement* THIS, RogueClassToken* _auto_1194_0, RogueClassCmd* _auto_1195_1, RogueClassCmd* _auto_1196_2 );
...
RogueClassCmdWriteArrayElement* RogueCmdWriteArrayElement__init__Token_Cmd_Cmd_Cmd( RogueClassCmdWriteArrayElement* THIS, RogueClassToken* _auto_1197_0, RogueClassCmd* _auto_1198_1, RogueClassCmd* _auto_1199_2, RogueClassCmd* _auto_1200_3 );
...
RogueClassCmdAdjustProperty* RogueCmdAdjustProperty__init__Token_Cmd_Property_Integer( RogueClassCmdAdjustProperty* THIS, RogueClassToken* _auto_1284_0, RogueClassCmd* _auto_1285_1, RogueClassProperty* _auto_1286_2, RogueInteger _auto_1287_3 );
